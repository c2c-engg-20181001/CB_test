...
function get_performance(req, res, next) {
    var content;
    var contents = [];
    ...
    request(options, function (error, response, body) {
        ...
        for (var i = 0; i < contents.length; i++) {
            ...
            var options = {
                ...
                url: 'https://management.azure.com/subscriptions/efbaf842-f428-4020-8718-9e3a642fa2c6/resourceGroups/' + resource_group + '/providers/Microsoft.Compute/virtualMachines/' + vmname + '/providers/microsoft.insights/metrics?api-version=2018-01-01&metricnames=Percentage%20CPU,Network%20OUT,Network%20IN&timespan=2019-05-15T05:45:00Z/2019-05-15T05:55:00Z&aggregation=Average,minimum,maximum,total',
            ...
            request(options, function (error, response, body) {
                ...
                for (var p = 0; p < b.value.length; p++) {
                    ...
                    Performance_data[q] = { location: region, vm_name: VMname[8], avg: avg, min: min, max: max, total: total, metricName: metricName, spike: spike };
                    q++;
                }



                if (Performance_data.length == (contents.length * 3)) {
...
exports.get_performance = get_performance;
